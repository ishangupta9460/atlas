...
public record UpdateCategoryRequest(
        ...
        @Size(min = 1, max = 255, message = "color must be between 1 and 255 characters") String color, tools.jackson.databind.JsonNode defaultImportance) {
    public UpdateCategoryRequest(String name, String defaultFlexibilityTier, String color) { this(name, defaultFlexibilityTier, color, null); }
}
